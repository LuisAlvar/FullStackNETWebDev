...
export class HealthCheckService {
  ...
  public result: Observable<Result|null> = this._result.asObservable();
  ...
  public addDataListeners() {
    this.hubConnection.on('Update', (msg) => {
      console.log("Update issued by server for the following reaons: " + msg);
      this.updateData();
    })

    this.hubConnection.on('ClientUpdate', (msg) => {
      console.log("Update issued by client for the following reaons: " + msg);
      this.updateData();
    })
